                ...
                <div
                  ...
                  <div className="mt-auto space-y-1">
                    ...
                    <div className="flex flex-wrap gap-1.5 sm:gap-2 text-[10px] sm:text-xs text-gray-600">
                      ...
                      <span className="border border-gray-300 text-purple-600 font-bold px-1.5 sm:px-2 py-0.5 rounded-full">
                        <FaGamepad className="inline-block mr-1 w-2.5 h-2.5 sm:w-3 sm:h-3" />
                        Gaming
                      </span>
                    </div>
                  </div>
